...
import { supportedLangs, listLangs, setHeightCodeBlocks } from './components/utils';
...
export default function Edit( { attributes, setAttributes, clientId } ) {
	...
	useEffect( () => {
		...
		if ( ownerDocument ) {
			const hcbTextarea = ownerDocument.querySelector( `#block-${ clientId } .youboucodeblock__textarea` );
